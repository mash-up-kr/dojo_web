...
export const getTestResponseMock = (
  ...
  data: faker.helpers.arrayElement([faker.word.sample(), undefined]),
...
export const getTestMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<DojoApiResponseString> | DojoApiResponseString),
) => {
  return http.get(
...
export const getSampleMock = () => [getTestMockHandler()];
