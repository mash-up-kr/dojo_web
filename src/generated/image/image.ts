...
export const uploadInfo = (
  ...
  return customInstance<DojoApiResponseImageUploadUrlResponse>(
    {
      url: "http://dojo-backend-eb-env.eba-33qhzuax.ap-northeast-2.elasticbeanstalk.com/image-upload-url",
      method: "GET",
      params,
      signal,
    },
...
export const getUploadInfoQueryOptions = <
  TData = Awaited<ReturnType<typeof uploadInfo>>,
  TError = ErrorType<unknown>,
>(
  params: UploadInfoParams,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof uploadInfo>>, TError, TData>
    >;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof uploadInfo>>> = ({
    signal,
  }) => uploadInfo(params, requestOptions, signal);

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof uploadInfo>>,
    TError,
    TData
  > & { queryKey: QueryKey };
};

export type UploadInfoQueryResult = NonNullable<
  Awaited<ReturnType<typeof uploadInfo>>
>;
