...
export const createQuestion = (
  ...
  return customInstance<DojoApiResponseQuestionId>(
    {
      url: "http://dojo-backend-eb-env.eba-33qhzuax.ap-northeast-2.elasticbeanstalk.com/admin/question",
      method: "POST",
...
export const bulkCreateQuestion = (
  ...
  return customInstance<DojoApiResponseListQuestionId>(
    {
      url: "http://dojo-backend-eb-env.eba-33qhzuax.ap-northeast-2.elasticbeanstalk.com/admin/question-bulk",
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const getBulkCreateQuestionMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type BulkCreateQuestionMutationResult = NonNullable<
  Awaited<ReturnType<typeof bulkCreateQuestion>>
>;
export type BulkCreateQuestionMutationBody =
  BodyType<QuestionBulkCreateRequest>;
export type BulkCreateQuestionMutationError = ErrorType<unknown>;

/**
 * @summary bulk create Question API
 */
export const useBulkCreateQuestion = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const createCustomQuestionSet = (
  ...
  return customInstance<DojoApiResponseQuestionSetId>(
    {
      url: "http://dojo-backend-eb-env.eba-33qhzuax.ap-northeast-2.elasticbeanstalk.com/admin/custom-question-set",
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const getCreateCustomQuestionSetMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type CreateCustomQuestionSetMutationResult = NonNullable<
  Awaited<ReturnType<typeof createCustomQuestionSet>>
>;
export type CreateCustomQuestionSetMutationBody =
  BodyType<QuestionSetCustomCreateRequest>;
export type CreateCustomQuestionSetMutationError = ErrorType<unknown>;

/**
 * @summary create custom QuestionSet API
 */
export const useCreateCustomQuestionSet = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
